...
This script is used with **decrypted** titlekeys from **decTitleKeys.bin**. If you need a tool that uses **encrypted** titlekeys and **encTitleKeys.bin** then use [@llakssz's tool](https://gbatemp.net/threads/423025/) instead.
